...
const CompletedVisitsTable: React.FC<Props> = props => {
    ...
    const loadData = useMemo(() => async () => {
        ...
        try {
            const res = await DataService.loadContracts({moduleName: 'Rental', entityName: 'Visited'})
...
export default connect<StateProps, DispatchProps, OwnProps, AppState>(null)(CompletedVisitsTable)