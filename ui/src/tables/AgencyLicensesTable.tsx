...
const AgencyLicensesTable: React.FC<Props> = props => {
    ...
    const loadData = useMemo(() => async () => {
        ...
        try {
            const res = await DataService.loadContracts({moduleName: 'Rental', entityName: 'AgencyLicense'})
...
export default connect<StateProps, DispatchProps, OwnProps, AppState>(null)(AgencyLicensesTable)