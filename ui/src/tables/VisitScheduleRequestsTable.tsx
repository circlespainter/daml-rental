...
const VisitScheduleRequestsTable: React.FC<Props> = props => {
    ...
    const loadData = useMemo(() => async () => {
        ...
        try {
            const res = await DataService.loadContracts({moduleName: 'Rental', entityName: 'VisitScheduleRequest'})
...
export default connect<StateProps, DispatchProps, OwnProps, AppState>(null)(VisitScheduleRequestsTable)