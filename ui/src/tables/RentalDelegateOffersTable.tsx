...
const RentalContractOffersTable: React.FC<Props> = props => {
    ...
    const columns = [
        ...
        { title: 'Current agency', field: 'payload.agency', editable: never },
        { title: 'New agency', field: 'payload.newAgency', editable: never },
    ...
    const loadData = useMemo(() => async () => {
        ...
        try {
            const res = await DataService.loadContracts({moduleName: 'Rental', entityName: 'RentalDelegateOffer'})
...
export default connect<StateProps, DispatchProps, OwnProps, AppState>(null)(RentalContractOffersTable)