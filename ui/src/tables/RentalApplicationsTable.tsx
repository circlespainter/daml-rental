...
const RentalApplicationsTable: React.FC<Props> = props => {
    ...
    const loadData = useMemo(() => async () => {
        ...
        try {
            const res = await DataService.loadContracts({moduleName: 'Rental', entityName: 'RentalApplication'})
...
export default connect<StateProps, DispatchProps, OwnProps, AppState>(null)(RentalApplicationsTable)