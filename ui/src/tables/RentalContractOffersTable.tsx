...
const RentalsContractOffersTable: React.FC<Props> = props => {
    ...
    const columns = [
        ...
        { title: 'Applicant', field: 'payload.applicant', editable: never },
        { title: 'Pending Contract ID', field: 'payload.rentalPendingContractCid', editable: never },
    ...
    const loadData = useMemo(() => async () => {
        ...
        try {
            const res = await DataService.loadContracts({moduleName: 'Rental', entityName: 'RentalContractOffer'})
...
export default connect<StateProps, DispatchProps, OwnProps, AppState>(null)(RentalsContractOffersTable)